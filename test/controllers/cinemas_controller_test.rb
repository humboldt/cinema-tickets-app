...
class CinemasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cinema" do
    assert_difference('Cinema.count') do
      post cinemas_url, params: { cinema: { address: @cinema.address, name: @cinema.name, user_id: @cinema.user_id } }
    end
  ...
  test "should update cinema" do
    patch cinema_url(@cinema), params: { cinema: { address: @cinema.address, name: @cinema.name, user_id: @cinema.user_id } }
